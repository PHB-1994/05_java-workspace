...
public class ExceptionEx2 {
     ...
     *
     * case 1 에서 문제가 발생할 경우 break 를 작성하지 않아도
     * 1번에서 문제가 발생했기 때문에 method1() 기능 자체를 중단하는 상황이 발생
     *
     * break 를 작성하지 않아도 case 2번 부터 default 까지 내용들이 출력되지 않음
     *
        ...
        while(true){
            ...
            switch(choice){
                ...
                Exception in thread "main" java.lang.ClassCastException
	               ...
	               at edu.exception.pack2.ExceptionRun2.main(ExceptionRun2.java:7)
	            case 3: throw new ClassCastException();
	            () 내부에 아무런 문자열을 작성하지 않았기 때문에
	            문제가 발생한 상황에 대해서
	            어떤 문제인지 개발자나 소비자가 알 수 없는 문제가 발생
                 */
    ...
    } catch(InputMismatchException e){ System.out.println("아래 단계에 따라 문제를 해결합시다.");
    } catch(NullPointerException e){ System.out.println("참조하는 객체가 없습니다.");
    } catch(NullPointerException e){ System.out.println("클래스 참조 문제 발생");
...
case 1:
        ...
        break; // 또 멈춘다고 ?! 멈춘 다음 또 다시 돌아와 멈춘다음 기능을 진행한다와 같음
    ...
    public void method2(){
        ...
        try{
            ...
            System.out.println("부모클래스 공간에서 자식클래스 메서드 실행했을 떄");
    ...
    public void method3(){
        try{
            // 각종 예외 강제로 발생시키고
                               ...
                               // 대응 처리를 하지 못하기 때문에 맨 아래에 작성하는 것
            System.out.println("예외는 어떤 예외들이 뜨는지 확인 후 157번 줄 위에" +
