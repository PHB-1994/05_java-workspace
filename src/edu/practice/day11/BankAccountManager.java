...
import java.util.*; // 유틸 폴더 내 모든 문서 calss 파일 가져오기
...
public class BankAccountManager {
    ...
    public void method1() {
        ...
        if(해당계좌금액 == null) { // 돈없음~~~ 계좌가 없어서 null
            ...
            // return 이 내부에 존재하기 때문에 아래 return 을 추가로 작성할 필요가 없음
            // throw new 이후 코드 실행 할 수 없기 때문
        }
    ...
    public void method2() {
        ...
        try {
            ...
            System.out.println("계좌 번호 주인의 성함을 입력하세요 : ");
            ...
            // 계좌 번호에서 가져온 계좌 주인이 일치하는지 일치하지 않은지 확인
            // 일치하지 않으면 NotFoundUserException 을 이용해서
