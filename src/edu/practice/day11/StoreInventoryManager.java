...
public class StoreInventoryManager {
    ...
    public void method3() {
        ...
        try {
            ...
            System.out.print("현재 재고 : " + inventoryMap.get(productName) + " 구매할 수량을 입력하세요 : ");
            ...
            if(quantity > 현재수량){
                ...
                priceMap.put(productName,현재수량 - quantity);
                System.out.println(productName + "의 " + quantity + "개 구매하였습니다. 남은 수량 : " + (현재수량-quantity) + "개");
            }
