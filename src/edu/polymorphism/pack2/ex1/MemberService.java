...
public class MemberService {
    // public static void main(){} 이외에 객체 생성은 모드 class 아래에 바로 작성
    ...
    public void display(){
        ...
        // 회원들은 향상된 for 문을 활용해서 일반 회원부터 프리미엄 회원, VIP 회원까지 순차적으로 개발자가 원하는 기능 실행
        for(Member 회원 :회원들){ // 회원들 리스트에 작성된 모든 회원들을 회원 이라는 변수이름에 하나씩 넣어서 기능 실행
            // 공통 메서드
            회원.login();
            ...
            System.out.println("할인된 최종 가격 : " + 할인된최종가격 + "원");

            // 일반회원에는 존재하지 않고, 프리미엄과 VIP 회원에는 존재하는 변수이름이 있음
            // 프리미엄에서 존재하는 것, VIP 존재하는 것 따로 출력하고 싶어요!
            회원.쿠폰과혜택();
