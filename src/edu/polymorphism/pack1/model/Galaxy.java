...
public class Galaxy extends SmartPhone {
    ...
    // html 에서 필수로 데이터 정보를 작성해야 하는 required 에 따라 결정되는 것이 많음
    // 기본 생성자         Galaxy 라는 객체를 생성할 때 기본적으로 갖추어야 하는 필드값 없이 생성
    public Galaxy() {
        super();
    }

    // 매개변수 생성자     매개변수 타입 SmartPhone 문서에 작성된 필드 값을 기본적으로 설정한 객체 생성
    ...
    public String toString() {
        ...
        return "Galaxy androidVersion" + getAndroidVersion() + super.toString();
