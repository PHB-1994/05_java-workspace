...
public class Iphone extends SmartPhone {
    ...
    // 객체를 생성할 때 iosVersion 데이터를 전달 받은 후 공간 생성
    public Iphone(int iosVersion) {
        this.iosVersion = iosVersion;
    }

    // 객체를 생성할 때 SmartPhone 필드 데이터를 전달 받은 후 공간 생성
    public Iphone(String display, String newsAgency, String ap) {
        super(display, newsAgency, ap);
    }

    // 객체를 생성할 때 SmartPhone + Iphone 필드 데이터를 전달 받은 후 공간 생성
    ...
    public String toString() {
        ...
        return "Iphone androidVersion" + getIosVersion() + super.toString();
