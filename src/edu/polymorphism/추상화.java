...
코드에서 추상화란...
추후 어떤 구현이 될지는 알 수 없지만 그 구현의 기능 명칭을 알 수 있음
...
public abstract class 파일이름 {
    ...
    // 추상화 할 기능 또한 abstract 를 작성해야하며 {} 는 생략한다.
}

That's too abstract for me to understand. - 너무 추상적이여서 이해하기 어려워
특정 구현 기술이 없어 모호한 기능을 나타내는 단어 {} 하나가 존재하지 않다는 이유로!
 */
