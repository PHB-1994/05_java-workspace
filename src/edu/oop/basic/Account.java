...
public class Account {
    ...
    // 단축키 Alt + Insert 를 클릭하면 생성자 getter setter 를 만들어주는 기능 실행
    // 메서드(기능) - 생성자
    //              생성자 - 기본
    //              생성자 - 필수

    // 메서드(기능) - 기본 생성자
    // c 형태로 되어있는  edu.oop.basic.Account 를 선택해서 작성
    public Account() {
    }
    ...
    // 메서드(기능) - setter : html 에서 사용자에게 전달받은 값을 자바의 변수이름 내부에 저장하는 역할
    /**
     * setter 주의할 점
     * if(계좌잔액 < 0 ){
     *     // 잔액은 음수가 될 수 없습니다.
    ...
    /*
        ...
        public void setName(String html에서 데이터를 전달받아올 변수이름) {
        this.name = html에서 데이터를 전달받아올 변수이름;
        }
    ...
    // 메서드(기능) - getter : DB 나 이메일 인증키와 같은 데이터를 사용자에게 전달하는 역할
