...
public class NationRun {
    public static void main(String[] args){
        ...
        // 이름 : "김철수", 나이 : 25, 성별 : '남', 주민등록번호 : "950814-153218"
        ...
        n1.age = 25;
        n1.gender = '남';
        System.out.printf("이름은 %s이고, %d세, %c성 입니다.",n1.name,n1.age,n1.gender);        
        */
        
        // n1.name = "홍길동"; // setName(String name) 의 형태가 매개변수로 값을 저장하는 형태
        n1.setName("홍길동");
        n1.setAge(25);
        n1.setGender('남');
        n1.setTel("010-1234-5678");
        n1.setAddress("서울시 강남구");
        // System.out.printf("이름은 %s이고, %d세, %c성 입니다.",n1.getName(),n1.getAge(),n1.getGender());


        // ===== 문제 2 : 필수생성자 활용 =====
        // 이름 : "이영희", 나이 : 17, 성별 : '여', 주민번호 : "070312-4567890"
        // 전화번호 : "010-9876-5432", 주소 : "부산시 해운대구"
        Nation n2 = new Nation("이영희",17,'여',"070312-4567890","010-9876-5432","부산시 해운대구");

        // ===== 문제 3번 : 필수생성자 활용 =====
        // 필수 생성자로 국민 객체 n3 을 생성한 후, setter를 사용하여 다음 정보를 설정하세요.
