...
public class MatchingService {
    ...
    public void displayMenu() {
        ...
        while (true) {
            ...
            switch (input) {
                ...
                case 3: updateMemberDetail(); break;
                case 0:
    ...
    public void registerNewMember() {
        ...
        if (checkAgeValid()) { // 가입이 완성되는 경우는 나이 기준이 true 이면 가입 완성
    ...
    public boolean checkAgeValid() {
        // this. MatchingMember 에서는 private 으로 가르키고 있는 필드 명칭
        // MatchMember 를 m 이라는 변수명칭으로 호출
