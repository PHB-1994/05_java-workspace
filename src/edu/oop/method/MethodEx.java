 ...
 *
 * 기본 구조
 * 접근제한자 [static] 반환타임 메서드명칭(매개변수 = 파라미터){
 *     // 실행할 코드
...
public class MethodEx {
    ...
    public void login(int userId, String password){
        System.out.println("userId와 password 가 일치합니다.");
    }
