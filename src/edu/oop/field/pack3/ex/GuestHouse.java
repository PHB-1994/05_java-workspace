...
public class GuestHouse {
    ...
    * */
    ...
    public static final int MAX_STAY_DAY = 30; // 최대 숙박 가능 일자
    public static final int MIN_STAY_DAY = 1; // 최소 숙박 가능 일자
    ...
    public void checkIn() {
        ...
        System.out.println(getGuestName() + " 님이 " + getRoomNumber() + " 호실에 체크인하였습니다.");
    }
