...
public class GuestHouseRun {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("guest2 이 보이는 총 방문자 수 : " + guest1.totalCount); // GuestHouse.totalCount
        System.out.println("guest2 이 보이는 총 방문자 수 : " + guest2.totalCount); // GuestHouse.totalCount
        ...
        guest1.guestInfo(); // 게스트 하우스가 공통적으로 제공하는 것 아닌 방문자 개별로 알아야 하는 정보
        guest2.guestInfo(); // 게스트 하우스가 공통적으로 제공하는 것 아닌 방문자 개별로 알아야 하는 정보
