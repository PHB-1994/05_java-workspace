...
public class 직원서비스 {
    ...
    public static void 회사정보() {
        ...
        // static 으로 처리된 동일한 이름의 변수 이름이 존재함
        /*
        ...
        위와 같이 import 해서 특정 데이터를 가져오는 것이 아니라 static 이 작성된
        클래스명칭.static변수명칭 과 같은 형태로 어떤 문서에서 가져오는 데이터인지 명확히 작성해주는 것이 좋음
         */
    ...
    public static void 더나은회사정보(){
        ...
        System.out.println("총사원수 : " + 더나은회사.사원수);
    }
}
