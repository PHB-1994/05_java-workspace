...
//            default: result = "잘못 입력하였습니다."; break;
//        }
//        System.out.println(result);
//    }

    // 한 클래스 내에서 동일한 명칭의 메서드를 사용하기 위해서는 매개변수를 각각 다르게 설정하거나
    // void -> return 전달받는 형식을 추가하는 방법이외에는 에러 발생
    public void method4(){
        Scanner sc = new Scanner(System.in);
        ...
        /*
        * 입력 값이 잘못 되었을 경우 메서드 기능을 중간에 종료
        * */
        String result;
        ...
        // else 에서는 result 에 해당하는 값이 존재하지 않아 발생하는 에러 표기
        System.out.println(result);
    }
}
