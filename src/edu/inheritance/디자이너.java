...
public class 디자이너 extends 직원{
    ...
    직원 클래스에 작성하고, 이외 추가로 필드 명칭만 디자이너에서 작성
    ...
    public 디자이너(String eName, int eId, double baseSalary, String department, String designTool) {
        // 하나하나 직접 작성해야하는 this 를 직원 클래스에 작성하고 super 를 이용하여
        // 직원 클래스에 작성된 this 를 참조해서 사용한다 표기
        // this.eName = eName;
        // this.eId = eId;
    ...
    /** @Override 표기 는 extends 상속 클래스로 가져온 기능을 재활용 한다는 표기
