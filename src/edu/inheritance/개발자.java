...
public class 개발자 extends 직원{
    ...
    public 개발자(String eName, int eId, double baseSalary, String department,String computer) {
        ...
        * 2) super(매개변수) : 직원 클래스 안에 존재하는 파라미터 생성자 의
        * */
        super(eName, eId, baseSalary, department);
        /*
        this 대신 super 를 사용해서 매개변수로 전달받은 eName, eid, baseSalary, department 사용하겠다. 처리
        this.eName = eName;
        this.eId = eId;
        this.baseSalary = baseSalary;
        this.department = department;
         */
        this.computer = computer; // this 를 여러번 작성 할 필요 없이 직원 클래스에 1번만 작성하고
                                  // 추가로 클래스 내에서 작상된 필드만 this 로 작성하면 됨
    }
    ...
    public void info(){
        ...
        System.out.println("=== 직원 정보 ===");
            // eName 을 직접적으로 사용해도 되지만
            // eName 을 직접적으로 사용하기 보다는 get 활용해서 작성
