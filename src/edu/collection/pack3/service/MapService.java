...
public class MapService {
    ...
    public void method2(){
        ...
        /*
        1 번의 경우 key 의 개수만큼 get 메서드를 지속적으로 호출
                    key 1번이어도 개수만큼 get 을 모두 다 가져옴

        2 번이 실무적으로 유용
        2 번의 경우 map2.entrySet() 으로 key-value 하나씩 하나씩 바로 접근
        2 번이 성능상 더 효율적
         */
        ...
        // 🤍 2번 방법 🤍
        // 향상된 for 문 + EntrySet
        // Map 이라는 클래스 내부에 Entry 라는 기능을 이용해서 key 와 value 를 확인하기 위한 기능
        //
        //
        // 향상된 for 문은 항상 끝나기 전 소괄호 앞에 존재하는 명칭이 기준!!!
        // 1. map2 이 어디서 선언되었고, map2 이라는 명칭의 공간이 생성되었는지 확인
        // 2. Map<String,String> map2 = new HashMap<>(); 의 map2 의 자료형 확인
        //        문자열 문자열 이기 때문에
