        ...
        while(true) {
            ...
            switch(menu) {
                ...
                case 3:
                    ...
                    int index = nameList.indexOf(modifyName); // 우리가 찾는 이름과 modify 가 일치하는 이름의 index 번호
                ...
                case 5:
                    ...
                    if(salaryList.isEmpty()){
                        ...
                        for(int s : salaryList ){ // 0 번부터 끝까지 모두 순회
                            sum += s;   // list 에서 하나씩 s 에 담긴 연봉을 모두 더하기
                        ...
                        System.out.println("최고 급여 : " + maxSalary + "원");
                        System.out.println("최저 급여 : " + minSalary + "원");
                    }
