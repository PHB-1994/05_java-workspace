...
public class OperatorEx {
    ...
    * */
    public void method1() {
       ...
       // boolean 변수 이름 보통 앞에 is 단어를 붙이므로 true / false 를 위한 변수이름 임을 표기
       //       위에서 sc.nextInt(); 내부에 소비자가 작성한 숫자 입력 값을 a 라는 변수이름에 저장한 후
       //       a 를 3으로 나누었을 때 나머지가 0 이 맞으면 3의 배수
    ...
    /*
    * 자바 라는 언어는 바구니에 들어갈 데이터가 숫자, 문자, 사람이 만든 크기, 실수 등
    * 데이터를 담을 변수이름의 종류부터
    *
    * 기능을 실행할 때
    * - 기능을 실행한 하면 되는 것인지?
    ...
    * */
    ...
    /*
    * method2() 기능
    *  첫 번째 입력 받은 수가 두 번재 입력 받은 수의 배수가 맞는지 확인
    *
    * 변수이름 :
    *           int = input1, input2
    *           boolean = isTrue            %           == 0;
    ...
    * */
    public void method2() {
        // Scanner 처럼 동일한 클래스는 최초 1회만 호출 후 여러번 사용 가능
        Scanner sc = new Scanner(System.in);
...
//        Scanner sc2 = new Scanner(System.in);
    ...
    * */
    public void method3(){
        ...
        * */
        boolean isTrue = (iuput % 2 == 0);

        String result = isTrue ? "짝수" : "홀수";
        System.out.printf("%d 은/는 %s 입니다.",iuput,result);
    }

    /*
    * [홀짝 검사기 V2]
    * 입력 받은 정수가 홀수 또는 짝수 또는 0 인지 판별
    * 정수 입력 : 0
    * 0 입니다.
    * --------------
    * 정수 입력 : 4
    ...
    * */
    public void method4(){
        ...
        /*
        boolean isZero = (input1 == 0); // 0 인지 검사
        boolean isTrue = (input1 % 2 == 0);

        // 이중 삼항 연산자
        //               0이 맞으면 0  : 0이 아니면 삼항 연사자를 통해 짝수 홀수 판별 후 출력
        String result = isZero ? "0" : (isTrue ? "짝수" : "홀수");
        */
        // 최종 결과로 input1 을 1차에서 0 인지 확인하고       아니라면 확인해서 짝수인지 홀수인지 판별
        String result = (input1 == 0) ? "0"          : ((input1 % 2 == 0) ? "짝수" : "홀수");
